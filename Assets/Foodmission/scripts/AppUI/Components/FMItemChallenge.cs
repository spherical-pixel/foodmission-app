...
{
    [UxmlElement]
    public partial class FMItemChallenge : VisualElement
    {
        /* ========= UXML ATTRIBUTES ========= */
        [UxmlAttribute("text")]
        [CreateProperty]
        ...
        public FMItemChallenge()
        {
            ...
            _codeText.AddToClassList("fm-challenge-item-title");
            ...
            _openButton.clicked += () => OnChallengeClicked?.Invoke();
            contentContainer.Add(_openButton);

            SetLevel(ChallengeLevel.Beginner);
            SetCompleted(false);
        }

        public void SetLevel(string level)
        {
            _level = level ?? ChallengeLevel.Beginner;
